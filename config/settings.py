...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-l23xu5cl3n)ol&8@24neht2bmfbmu0+pptg#kb$_^r30h-iy1g',
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'marketplace_assistant'),
        'USER': os.environ.get('POSTGRES_USER', 'marketplace_assistant'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'marketplace_assistant'),
